...
{
    public sealed class SmartRailroad : Railroad, ISmartLocation
    {
        Type ISmartLocation.BaseType { get; } = typeof(Railroad);
        public SmartLocationProxy Proxy { get; }

        public SmartRailroad() { Proxy = new SmartLocationProxy(this); }
