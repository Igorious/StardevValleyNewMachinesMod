...
{
    public sealed class SmartFarmCave : FarmCave, ISmartLocation
    {
        Type ISmartLocation.BaseType { get; } = typeof(FarmCave);
        public SmartLocationProxy Proxy { get; }

        public SmartFarmCave() { Proxy = new SmartLocationProxy(this); }
