...
{
    public sealed class SmartForest : Forest, ISmartLocation
    {
        Type ISmartLocation.BaseType { get; } = typeof(Forest);
        public SmartLocationProxy Proxy { get; }

        public SmartForest() { Proxy = new SmartLocationProxy(this); }
