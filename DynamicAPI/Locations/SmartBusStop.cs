...
{
    public sealed class SmartBusStop : BusStop, ISmartLocation
    {
        Type ISmartLocation.BaseType { get; } = typeof(BusStop);
        public SmartLocationProxy Proxy { get; }

        public SmartBusStop() { Proxy = new SmartLocationProxy(this); }
